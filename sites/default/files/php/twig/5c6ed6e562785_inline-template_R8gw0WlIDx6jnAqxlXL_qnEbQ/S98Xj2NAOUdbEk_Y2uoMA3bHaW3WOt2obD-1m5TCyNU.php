...
/* {# inline_template_start #}{{ link_flag }} <div class="count">{{ count }} </div>
 */
class __TwigTemplate_4ee2e89c448f923a9c76748b9194784b18ed9ae28851fc00e17289f0df45ee27 extends Twig_Template
{
...
";
    ...
    {
        return "{# inline_template_start #}{{ link_flag }} <div class=\"count\">{{ count }} </div>
";
    }
    ...
    {
        return new Twig_Source("", "{# inline_template_start #}{{ link_flag }} <div class=\"count\">{{ count }} </div>
", "");
    }
}
